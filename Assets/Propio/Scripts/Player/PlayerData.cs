...
public class PlayerData
{
    ...
    public PlayerData(GameObject player, int score, GameObject Camera)
    {

        // Conversion dentro del player
        health = player.gameObject.GetComponent<PlayerHealth>().currentHealth;
